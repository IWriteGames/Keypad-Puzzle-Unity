...
[![Available on itch.io](http://jessemillar.github.io/available-on-itchio-badge/badge-color.png)](https://i-write-games.itch.io/keypad-puzzle)
...
The panel is a 3D modelling created by me in Blender 3.
...
When I moved it to Unity, I kept the structure of the project and the logic of the puzzle is contained in a single file called Panel.cs
The code is clean and ordered... But could it be improved?

Is it possible to optimise using arrays and is it necessary to create 9 functions for each button?
